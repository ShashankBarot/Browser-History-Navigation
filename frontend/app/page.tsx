...
export default function Home() {
  ...
  return <main className="app-shell">
    ...
    <section className="hero"><Beams beamWidth={2} beamHeight={15} beamNumber={12} lightColor="#7089ba" beamColor="#1c1c1c" backgroundColor="#000000" speed={1.5} noiseIntensity={1.5} scale={0.2} rotation={0} /><div className="hero-shade" /><div className="hero-copy"><span className="eyebrow"><Sparkles size={12} /> INTERACTIVE DATA STRUCTURE LAB</span><h1>Browser history<br />navigator<span className="headline-dot">.</span></h1><p>A browser history simulator that makes every pointer, traversal, and insertion visible.</p></div><HeroLinkedList history={history} /></section>
